// constants.js
module.exports = {
  IDEAS_SAMPLE_PROMPT: `Imagine you are part of the innovation team at a CPG company. Your goal is to create new innovative products consumers will love. 
  The demographic you are targeting are \`Gen Z\` and \`Millenials\`.

  Incorporate the following fruits into a trending ***product_line***.
  
  Fruit: ***ingredient***
  
  The ***product_line*** should have the following attributes
  Taste: ***taste***
  Aroma: ***aroma***
  Texture: ***texture***
  
  Here are some examples of our current ***product_line*** for inspiration:
  
  ***product_line_examples***
  `,
